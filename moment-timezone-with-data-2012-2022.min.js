!function(a, i) {
    ...
    function e(a) {
        var e = 0
          ...
          , n = 0
          , t = 1;
        for (45 === a.charCodeAt(0) && (e = 1,
        t = -1),
        e; e < o.length; e++)
            n = 60 * n + i(o.charCodeAt(e));
        for (e = 0; e < A.length; e++)
            c /= 60,
            n += i(A.charCodeAt(e)) * c;
        return n * t
    }
    function r(a) {
    ...
    function m() {
        ...
        for (e = 1; e < 48; e++)
            (i = new t(new Date(r,e,1))).offset !== o.offset && (a = u(o, i),
            A.push(a),
            A.push(new t(new Date(a.at + 6e4)))),
            o = i;
        for (e = 0; e < 4; e++)
    ...
    function h(a, i) {
        a = M(a);
        var e, r = N[a];
        return r instanceof n ? r : "string" == typeof r ? (r = new n(r),
        N[a] = r,
        r) : C[a] && i !== h && (e = h(C[a], h)) ? ((r = N[a] = new n)._set(e),
        r.name = O[a],
        r) : null
    }
    function z(a) {
    ...
    function E(a) {
        d(a.zones),
        z(a.links),
        P.dataVersion = a.version
    }
    function g(a) {
        return g.didShowError || (g.didShowError = !0,
        S("moment.tz.zoneExists('" + a + "') has been deprecated in favor of !moment.tz.zone('" + a + "')")),
        !!h(a)
    }
    function T(a) {
        var i = "X" === a._f || "x" === a._f;
    ...
    function P(i) {
        ...
        return o && !a.isMoment(i) && T(A) && A.add(o.parse(A), "minutes"),
        A.tz(r),
        A
    }
    function _(a) {
    ...
    (B < 2 || 2 === B && L < 6) && S("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + a.version + ". See momentjs.com"),
    n.prototype = {
        _set: function(a) {
            this.name = a.name,
            this.abbrs = a.abbrs,
        ...
        parse: function(a) {
            ...
            for (o = 0; o < t; o++)
                ...
                e = c[o + 1],
                r = c[o ? o - 1 : o],
                i < e && P.moveAmbiguousForward ? i = e : i > r && P.moveInvalidForward && (i = r),
                A < n[o] - 6e4 * i)
                    return c[o];
            return c[t]
        },
    ...
    a.updateOffset = function(i, e) {
        ...
        void 0 === i._z && (o && T(i) && !i._isUTC && (i._d = a.utc(i._a)._d,
        i.utc().add(o.parse(i), "minutes")),
        i._z = o),
        i._z && (r = i._z.utcOffset(i),
        Math.abs(r) < 16 && (r /= 60),
        void 0 !== i.utcOffset ? i.utcOffset(-r, e) : i.zone(r, e))
    }
    ,
    y.tz = function(i, e) {
        return i ? (this._z = h(i),
        this._z ? a.updateOffset(this, e) : S("Moment Timezone has no data for " + i + ". See http://momentjs.com/timezone/docs/#/data-loading/."),
    ...
    a.tz.setDefault = function(i) {
        return (B < 2 || 2 === B && L < 9) && S("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + a.version + "."),
